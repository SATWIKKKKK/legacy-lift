...
import GlowingCard from "../components/ui/glowing-card.jsx"
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-36 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          {/* AI Badge */}
          <GlowingCard>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/50 bg-white/10 mb-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <GlowingCard>
              <div className="p-6 rounded-2xl bg-gray-900 border border-gray-800 hover:border-white/50 transition-all group">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <GlowingCard>
            <div className="p-12 rounded-3xl bg-gray-900 border border-white/30">
